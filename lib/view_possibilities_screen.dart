              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Text(''),
                    Text('Score: ${mainGameState.score.toStringAsPrecision(3)}'),
                    Text('Score From Positioning: ${mainGameState.scoreFromPositioning.toStringAsPrecision(3)}'),
                    Text(
                        'Score From Proximity to Other Owned Pieces: ${mainGameState.scoreFromPieceProximity.toStringAsPrecision(3)}'),
                    Text('Score From Two in a Rows: ${mainGameState.scoreFromTwoInARows.toStringAsPrecision(3)}'),
                    Text('Score From Piece Count Increase: ${mainGameState.scoreFromUpgrading.toStringAsPrecision(3)}'),
                    Text('Score From Winning: ${mainGameState.scoreFromWinning.toStringAsPrecision(3)}'),
                  ],
                ),
              ],
            ),
